...
def create_hit_group(data, task_param_generator, **kwargs):
    ...
    """
    hit_batch = [_create_html_hit_params(**task_param_generator(point, **kwargs), **kwargs)
                 for point in data]
...
def create_single_hit(data_point, task_param_generator, **kwargs):
    ...
    :return: hit objects created
    """
    single_hit = _create_html_hit_params(**task_param_generator(data_point, **kwargs), **kwargs,)
...
def preview_hit_interface(data_point, task_param_generator, **kwargs):
    ...
    hit_html = _render_hit_html(**task_param_generator(data_point, **kwargs), **kwargs)
